...
| Model | Paper | Code |
| :--- | :--- | :--- |
| **ESRT** 🆕 | **Bandwidth-Efficient and Privacy-Preserving Edge-Cloud Many-to-Many Speech Translation** <br> Y. Du, K. Liu, Y. Pan, B. Yang, M. Liu, B. Qin, Y. Xiang <br> *arXiv, 2026* | [![Code](https://img.shields.io/badge/Github-181717?style=flat&logo=github&logoColor=white)](https://github.com/yxduir/ESRT) <br> [![Models](https://img.shields.io/badge/%F0%9F%A4%97%20-Models-FFD21E?style=flat)](https://huggingface.co/yxdu/ESRT-4B) |
| **MCAT** | **MCAT: Scaling Many-to-Many Speech-to-Text Translation with MLLMs to 70 Languages** <br> Y. Du, K. Liu, Y. Pan, B. Yang, K. Deng, X. Chen, Y. Xiang, M. Liu, B. Qin, Y. Wang <br> *IEEE TASLP, 2026* | [![Code](https://img.shields.io/badge/Github-181717?style=flat&logo=github&logoColor=white)](https://github.com/yxduir/m2m-70) |
