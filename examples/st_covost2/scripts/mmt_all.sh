...
source=covost_en
checkpoint_dir=${code}/data/output/asr-3B-encoder-15lang
output_dir=${code}/data/output/asr-3B-encoder-15lang-mmt

encoder_path_hf=${code}/models/whisper-large-v3
llm_path=${code}/models/Qwen2.5-3B
#change your train data

/mgData3/zhaozhiyuan/vits/hit/code/
train_data_path=${code}/SLAM-LLM/examples/st_covost2/mmt-all/wavs/mmt_train_200.jsonl
val_data_path=${code}/SLAM-LLM/examples/st_covost2/mmt-all/wavs/mmt_test.jsonl
